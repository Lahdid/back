...
import { linkChild, getChildrenByParent, unlinkChild, setChildSafeZone } from "../controllers/parentController.js";
...
router.route("/SetSafeZone").put(checkCurrentUser,setChildSafeZone);
